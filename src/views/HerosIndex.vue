                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="row g-0 gy-0">
                        <div class="col-md-3">
                          <div class="modalBorders">
                            {{hero.first_power_color}}: {{hero.first_power_cost}}
                          </div>
                        </div>
                        ...
                        <div class="col-md-9">
                          <div class="modalBorders">
                            {{hero.first_power_name}}: {{hero.first_power_description}}
                          </div>
                        </div>
                    ...
                    <div class="row g-0 gy-0">
                      <div class="col-3">
                        <div class="modalBorders">
                          {{hero.second_power_color}}: {{hero.second_power_cost}}
                        </div>
                      </div>

                      <div class="col-9">
                        <div class="modalBorders">
                          {{hero.second_power_name}}: {{hero.second_power_description}}
                        </div>
                      </div> 
                    </div>
                    ...
                    <div class="row g-0 gy-0">
                      <div class="col-3">
                        <div class="modalBorders">
                          {{hero.third_power_color}}: {{hero.third_power_cost}}
                        </div>
                      </div>

                      <div class="col-9">
                        <div class="modalBorders">
                          {{hero.third_power_name}}: {{hero.third_power_description}}
                        </div>
                      </div>
